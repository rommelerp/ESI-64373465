...
<body>
    ...
    <div class="formulario">
        ...
        <form action="<?php echo $base_url; ?>Controladores/Usuario/registrar.php" method="post">
            <div class="all">
                <h1>Registro</h1>
                <br>
                <br>
                ...
                <br>
                <br>
                <input type="number" inputmode="numeric" placeholder="Cedula" name="cedula" required>
                <br>
                <br>
                ...
                <select name="rol" required>
                    ...
                    <option value="funcionario">Funcionario de Almacen</option>
