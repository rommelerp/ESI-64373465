...
<body>
    ...
    <div class="formulario">
        ...
        <form action="<?php echo $base_url; ?>Controladores/Usuario/modificar.php" method="post">
            <div class="all">
                <h1> Modifique</h1>
                <br>
                <input type="text" name="nombre" value="<?php echo $datosUsuario[0]['nombre']; ?>" required>
                <br>
                <br>
                <input type="text" name="apellido" value="<?php echo $datosUsuario[0]['apellido']; ?>" required>
                <br>
                <br>
                <input type="text" name="cedula" value="<?php echo $datosUsuario[0]['cedula']; ?>" required>
                <br>
                <br>
                <input type="text" name="rol" value="<?php echo $datosUsuario[0]['rol']; ?>" required>
                <br>
                <br>
                <input type="text" name="telefono" value="<?php echo $datosUsuario[0]['telefono']; ?>" required>
                <br>
                <br>
                <input type="hidden" name="cedulaOriginal" value="<?php echo $datosUsuario[0]['cedula']; ?>" required>
