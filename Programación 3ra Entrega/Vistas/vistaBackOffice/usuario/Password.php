...
<body>
    ...
    <center>
        <div class="formulario">
            ...
            <form action="<?php echo $base_url; ?>Controladores/Usuario/password.php" method="post" autocomplete="off">
                <div class="all">
                    <h1> Ingrese cedula y nueva contraseña</h1>
                    <br>
                    <input type="text" name="cedula" placeholder="Cedula" autocomplete="off" required>
                    <br>
                    <br>
                    <input type="password" name="password" placeholder="Nueva contraseña:" required>
                    <br>
                    <br>
                    <input type="submit" value="Modificar" id="Entrar">
                </div>
            </form>
        </div>
