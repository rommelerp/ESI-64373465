...
<body>
    ...
    <center>
        ...
        $countSql = "SELECT COUNT(*) AS total FROM login";
        ...
        $sql = "SELECT login.cedula, login.nombre, login.apellido, login.rol, login.telefono
    FROM login
    ...
    <tr>
        ...
        <th>Telefono</th>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo '<tr>';
                    $keys = array("cedula", "nombre", "apellido", "rol", "telefono");
                ...
                echo '<tr><td colspan="5" style="text-align: center;">'; // Cambié el colspan a 3 para que coincida con el número de columnas
