...
<body>
    ...
    <center class="frform">
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Vehiculo/eliminarCamion.php" method="post">
                <div class="all">
                    <h1>Ingrese CAMION para eliminar</h1>
                    <br>
                    <input type="text" name="matriculaCamion" placeholder="Matricula">
                    <br>
                    <br>
        ...
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Vehiculo/eliminarCamioneta.php" method="post">
                <div class="all">
                    <h1>Ingrese CAMIONETA para eliminar</h1>
                    <br>
