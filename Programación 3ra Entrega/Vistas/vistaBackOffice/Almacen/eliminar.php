...
<body>
    ...
    <center>
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Almacen/eliminar.php" method="post">
                <div class="all">
                    <h1>Ingrese para eliminar</h1>
                    <br>
                    <input type="text" name="idAlmacen" placeholder="Id Almacen" required>
                    <br>
                    <br>
                    <input type="submit" id="Entrar" value="Aceptar" required>
            </form>
        </div>
    </center>
</body>
