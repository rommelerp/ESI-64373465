...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $base_url; ?>Vistas/vistaBackOffice/css/Admin.css">
...
<body>
    ...
    <center>
        <div class="container">
            <a href="<?php echo $base_url; ?>Vistas/vistaBackOffice/Almacen/Almacen.php">
                <div class="button uno">
                    <p>Almacen</p>
                </div>
            </a>
            <a href="<?php echo $base_url; ?>Vistas/vistaBackOffice/lote/index.php">
                <div class="button dos">
                    <p>Lote</p>
                </div>
            </a>
            <a href="<?php echo $base_url; ?>Vistas/vistaBackOffice/paquete/index.php">
                <div class="button tres">
                    <p>Paquete</p>
                </div>
            </a>
            <a href="<?php echo $base_url; ?>Vistas/vistaBackOffice/trayecto/index.php">
                <div class="button cuatro">
                    <p>Trayecto</p>
                </div>
            </a>
            <a href="<?php echo $base_url; ?>Vistas/vistaBackOffice/Vehiculo/vehiculo.php">
                <div class="button cinco">
                    <p>Vehículo</p>
                </div>
            </a>
            <a href="<?php echo $base_url; ?>Vistas/vistaBackOffice/usuario/index.php">
                <div class="button seis">
                    <p>Usuario</p>
                </div>
            </a>
