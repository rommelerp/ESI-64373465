...
<body>
    ...
    <center class="frform">
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Vehiculo/registrar.php" method="post">
                <div class="all">
                    <h1>Registro Camioneta</h1>
                    <br>
                    <br>
                    <input type="text" placeholder="Matricula" name="matricula" required>
                    <br>
                    <br>
                    <label for="estadoCamioneta">Estado</label>
                    ...
                    <br>
                    <br>
                    <input type="text" placeholder="Tarea de camioneta: " name="tareaCamioneta" required>
                    <br>
                    <br>
        ...
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Vehiculo/registrar.php" method="post">
                <div class="all">
                    ...
                    <br>
                    <br>
                    <input type="text" placeholder="Tarea del camion: " name="tareaCamion" required>
                    <br>
                    <br>
                    <button id="Entrar"><input type="submit" id="Entrar" value="Registrar"></button>
                </div>
