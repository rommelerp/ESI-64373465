...
<body>
    ...
    <center>
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Almacen/asignarTrayecto.php" method="post">
                <div class="all">
                    <h1>Asignar trayecto</h1>
                    <br>
                    <input type="text" name="idAlmacen" placeholder="ID almacen" required>
                    <br>
                    <br>
                    <input type="text" name="idTrayecto" placeholder="ID trayecto" required>
                    <br>
                    <br>
