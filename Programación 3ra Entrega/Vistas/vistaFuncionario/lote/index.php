...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $base_url; ?>Vistas/vistaFuncionario/css/Lote.css">
...
<body>
    ...
    <center>
        ...
        $countSql = "SELECT COUNT(*) AS total FROM lote";
        ...
        $sql = "SELECT tiene.ordenEntrega, lote.idLote, tiene.matricula, almacena.idAlmacen, almacena.idTrayecto, lote.fechaCreacion, lote.estadoLote
    FROM lote
    LEFT JOIN tiene ON lote.idLote = tiene.idLote
    LEFT JOIN almacena ON lote.idLote = almacena.idLote
    ...
    <tr>
        ...
        <th>Estado Lote</th>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo '<tr>';
                    $keys = array("ordenEntrega", "idLote", "matricula", "idTrayecto", "idAlmacen", "fechaCreacion", "estadoLote");
                ...
                echo '<tr><td colspan="123" style="text-align: center;">';
