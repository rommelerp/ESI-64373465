...
<body>
    ...
    <center>
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Lote/asignarLoteAlmacen.php" method="post">
                <div class="all">
                    <h1>Asignar almacen</h1>
                    <br>
                    <input type="text" placeholder="idLote" name="idLote" required>
                    <br>
                    <br>
                    <input type="text" placeholder="idAlmacen" name="idAlmacen" required>
                    <br>
                    <br>
