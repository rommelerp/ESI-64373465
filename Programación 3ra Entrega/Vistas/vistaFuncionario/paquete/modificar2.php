...
<body>
    ...
    <center>
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Paquete/modificar.php" method="POST">
                <div class="all">
                    <h1> Modificar</h1>
                    <br>
                    <input type="text" placeholder="idPaquete" name="idPaquete"
                        value="<?php echo $datosPaquete[0]['idPaquete']; ?>" required>
                    <br>
                    <br>
                    <label for="estadoPaquete">Estado</label>
                    <select name="estadoPaquete" required>
                        <?php
                        $estadoActual = $datosPaquete[0]['estadoPaquete'];
                        $estados = array(
                            "En Proceso",
                            "En ruta",
                            "Almacenado",
                            "En camino al propietario",
                            "Entregado"
                        );
                    ...
                    <br>
                    <br>
                    <input type="text" placeholder="propietario" name="propietario"
                        value="<?php echo $datosPaquete[0]['propietario']; ?>" required>
                    <br>
                    <br>
                    <input type="text" placeholder="puertaPaquete" name="puertaPaquete"
                        value="<?php echo $datosPaquete[0]['puertaPaquete']; ?>" required>
                    <br>
                    <br>
                    <input type="text" placeholder="callePaquete" name="callePaquete"
                        value="<?php echo $datosPaquete[0]['callePaquete']; ?>" required>
                    <br>
                    <br>
                    <input type="text" placeholder="ciudadPaquete" name="ciudadPaquete"
                        value="<?php echo $datosPaquete[0]['ciudadPaquete']; ?>" required>
                    <br>
                    <br>

                    <input type="hidden" name="idPaqueteActual" value="<?php echo $datosPaquete[0]['idPaquete']; ?>"
                        required>
