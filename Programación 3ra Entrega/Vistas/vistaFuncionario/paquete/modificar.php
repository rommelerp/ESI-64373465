...
<body>
    ...
    <center>
        <div class="formulario">
            <form action="<?php echo $base_url; ?>Controladores/Paquete/getWhere/getWhere.php" method="get">
                <div class="all">
                    <h1>Ingrese ID para modificar</h1>
                    <br>
                    <input type="hidden" name="nombreArchivo" value="modificar2.php">
                    <input type="number" name="idPaquete" placeholder="ID">
                    <br>
                    <br>
